...
def automation_readiness_block() -> dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "active_candidate_is_market_neutral":
                (lane.get("active_candidate_detail") or {}).get("is_market_neutral"),
...
def _render_automation_readiness_html(panel: dict) -> str:
    ...
    if ar.get("active_candidate"):
        ...
        parts.append('<div class="jv-detail">Market-neutral (no buy-and-hold '
                     'beta): <b>%s</b></div>'
                     % _esc(ar.get("active_candidate_is_market_neutral")))
    else:
