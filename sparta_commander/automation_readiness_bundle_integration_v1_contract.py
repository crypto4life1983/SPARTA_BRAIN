...
def build_automation_readiness_integration() -> dict[str, Any]:
    ...
    record: dict[str, Any] = {
        ...
        "label": (
            ...
            "Candidate #19 (OOS-validated beta-neutral cross-sectional relative value) "
            "is now REJECTED at the real-candle labels / neutrality gate (kept on "
            "record); there is NO active/open candidate and the next stage is "
            "AUTOMATION READINESS. Executes nothing; "
        ...
        # C19 is rejected at the labels/neutrality gate -> surface the last rejected
...
def validate_automation_readiness_integration(record: dict[str, Any]) -> dict[str, Any]:
    ...
    # the integration follows the lane's CURRENT directive: C19 is REJECTED at
    # the labels/neutrality gate, there is NO active/open candidate, and the next stage is
