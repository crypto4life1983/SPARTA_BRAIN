...
the Strategy Factory backbone as of Bundle 49 (Crypto-D1 research-only dry-run
preview contract complete). It requires no IO to produce the default status.
...
Bundle 49 only means the research-only dry-run preview *contract* exists on
...
_HUMAN_WORKFLOW: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "reason": "Strategy Factory backbone (Bundles 11-49) complete on paper.",
    },
    {
        "id": "fake_lane",
        "label": "Fake Lane",
    ...
    },
    {
        ...
        "state": STATE_CURRENT,
        "reason": (
            "You are here. Bundles 42-49 contract chain is complete on paper, "
            "through the Crypto-D1 research-only dry-run preview contract. Next "
            "is a research-only, dry-run-review-only paper contract to be built, "
            "still on paper. Nothing is authorized to run: real strategy intake "
...
_MACHINE_PIPELINE: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "reason": (
            ...
            "dry-run-review-only paper contract template to be BUILT after the "
            "research-only dry-run preview contract. Building it acquires no "
