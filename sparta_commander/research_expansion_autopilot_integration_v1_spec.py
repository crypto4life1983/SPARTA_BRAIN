...
CANONICAL_REJECTED_FAMILIES = tuple(_rep.REJECTED_FAMILIES_C1_TO_C19)
...
def validate_integration_spec(record: dict[str, Any]) -> dict[str, Any]:
    ...
    if record.get("canonical_rejected_families_count") != 24:
        failures.append("canonical_ledger_not_24")
