...
CANONICAL_REJECTED_FAMILIES = tuple(_rep.REJECTED_FAMILIES_C1_TO_C17)
...
def validate_integration_spec(record: dict[str, Any]) -> dict[str, Any]:
    ...
    if record.get("canonical_rejected_families_count") != 22:
        failures.append("canonical_ledger_not_22")
