...
proposed *research-design-review approval* into a contract which VALIDATES, on paper,
whether the research design review recorded by the Block 111 Crypto-D1 Strategy Candidate
Research Design Review Contract is complete, safe, research-only, and ready before any
later research-only step. It consumes the stable constants of the Research Design Review
Contract (Block 111), the Research Plan Approval Contract (Block 107), the Research
...
and the Next Research Protocol (Block 95), and only when the upstream research-design-review
signal is clearly the expected READY one
(crypto_d1_strategy_candidate_research_design_review_contract_active is True,
research_design_review_verdict == STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY,
next_gate ==
CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY_SEPARATE_HUMAN_NEXT_STEP_REQUIRED,
mode == RESEARCH_ONLY, read_only is True, executes is False) evaluates a proposed
research-design-approval packet on paper and returns a deterministic verdict describing
...
research design review: external bot evidence stays observation-only and never becomes
...
Reaching a STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_READY verdict unlocks NOTHING
real. It only records, on paper, that a proposed research-design-review approval stays in
scope and confirms every stance -- and even that still requires a separate, later,
human step. Any upstream research-design-review signal that is missing, malformed, not
READY, in the wrong mode, executable, non-read-only, or pointed at a different next
gate yields the AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT
verdict.

Public API:
  - RESEARCH_DESIGN_APPROVAL_SCHEMA_VERSION
  - DEFAULT_RESEARCH_DESIGN_APPROVAL_LABEL
  - RESEARCH_DESIGN_APPROVAL_STATUS
  - RESEARCH_DESIGN_APPROVAL_SAFETY_POSTURE
  - RESEARCH_DESIGN_APPROVAL_STATE_ACTIVE
  - RESEARCH_DESIGN_APPROVAL_STATE_BLOCKED
  - RESEARCH_DESIGN_APPROVAL_VERDICT_READY
  - RESEARCH_DESIGN_APPROVAL_VERDICT_NEEDS_MORE_INFO
  - RESEARCH_DESIGN_APPROVAL_VERDICT_REJECTED
  - RESEARCH_DESIGN_APPROVAL_VERDICT_PARKED
  - RESEARCH_DESIGN_APPROVAL_VERDICT_AWAIT
  - ALLOWED_RESEARCH_DESIGN_APPROVAL_VERDICTS
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_VERDICT
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_NEXT_GATE
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_MODE
  - RESEARCH_DESIGN_APPROVAL_NEXT_REQUIRED_ACTION
  - RESEARCH_DESIGN_APPROVAL_CURRENT_STAGE
  - DECISION_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_CONTRACT_REQUIRED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_READY
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_FIX_REQUIRED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_PARKED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_REJECTED
  - NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_CONTRACT
  ...
  - RESEARCH_DESIGN_APPROVAL_EVALUATION_OUTCOMES
  - RESEARCH_DESIGN_APPROVAL_REQUIRED_SAFEGUARDS
  - RESEARCH_DESIGN_APPROVAL_VALIDATION_BOUNDARIES
  - REQUIRED_RESEARCH_DESIGN_APPROVAL_FIELDS
  - RESEARCH_DESIGN_APPROVAL_REQUIRED_TEXT_FIELDS
  - RESEARCH_DESIGN_APPROVAL_REQUIRED_AFFIRMATIONS
  - RESEARCH_DESIGN_APPROVAL_FORBIDDEN_ALLOW_FLAGS
  - ALLOWED_RESEARCH_DESIGN_APPROVAL_MODES
  - AUTOMATED_APPROVAL_MARKERS
  - REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED
  - evaluate_crypto_d1_strategy_candidate_research_design_approval(packet)
  - build_crypto_d1_strategy_candidate_research_design_approval_contract(signal, packet=None)
  - validate_crypto_d1_strategy_candidate_research_design_approval_contract(contract)
  - render_crypto_d1_strategy_candidate_research_design_approval_contract_markdown(contract)
"""
...
from sparta_commander.strategy_factory_crypto_d1_strategy_candidate_research_design_review_contract import (  # noqa: E501
    RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION as _RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION,  # noqa: E501
    RESEARCH_DESIGN_REVIEW_VERDICT_READY as _RESEARCH_DESIGN_REVIEW_VERDICT_READY,  # noqa: E501
    NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_READY as _NEXT_GATE_RESEARCH_DESIGN_REVIEW_READY,  # noqa: E501
...
__all__ = [
    ...
    "AUTOMATED_APPROVAL_MARKERS",
    "REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED",
    "evaluate_crypto_d1_strategy_candidate_research_design_approval",
    "build_crypto_d1_strategy_candidate_research_design_approval_contract",
    "validate_crypto_d1_strategy_candidate_research_design_approval_contract",
    "render_crypto_d1_strategy_candidate_research_design_approval_contract_markdown",
]

RESEARCH_DESIGN_APPROVAL_SCHEMA_VERSION = (
    "strategy_factory_crypto_d1_strategy_candidate_research_design_approval_contract.v1"
)
DEFAULT_RESEARCH_DESIGN_APPROVAL_LABEL = (
    "Strategy Factory Crypto-D1 Strategy Candidate Research Design Approval Contract"
)
RESEARCH_DESIGN_APPROVAL_STATUS = (
    "READ_ONLY_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_CONTRACT"
)
...
RESEARCH_DESIGN_APPROVAL_STATE_BLOCKED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_CONTRACT_BLOCKED"
)

RESEARCH_DESIGN_APPROVAL_VERDICT_READY = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_READY"
)
RESEARCH_DESIGN_APPROVAL_VERDICT_NEEDS_MORE_INFO = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_NEEDS_MORE_INFO"
)
RESEARCH_DESIGN_APPROVAL_VERDICT_REJECTED = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_REJECTED"
)
RESEARCH_DESIGN_APPROVAL_VERDICT_PARKED = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_PARKED"
)
RESEARCH_DESIGN_APPROVAL_VERDICT_AWAIT = (
    "AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT"
)

ALLOWED_RESEARCH_DESIGN_APPROVAL_VERDICTS: tuple[str, ...] = (
    RESEARCH_DESIGN_APPROVAL_VERDICT_READY,
    RESEARCH_DESIGN_APPROVAL_VERDICT_NEEDS_MORE_INFO,
    RESEARCH_DESIGN_APPROVAL_VERDICT_REJECTED,
    RESEARCH_DESIGN_APPROVAL_VERDICT_PARKED,
...
# The exact upstream research-design-review signal this contract activates from
# (Block 111). The contract only becomes active when the upstream design contract
# is clearly READY, in RESEARCH_ONLY mode, read-only, non-executing, and pointed
# at exactly this research-design-approval contract being built next.
UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_VERDICT = (
    _RESEARCH_DESIGN_REVIEW_VERDICT_READY
)
UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_NEXT_GATE = (
    _NEXT_GATE_RESEARCH_DESIGN_REVIEW_READY
)
UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_MODE = "RESEARCH_ONLY"
...
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_READY = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_READY_SEPARATE_HUMAN_"
    "NEXT_STEP_REQUIRED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_FIX_REQUIRED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_FIX_REQUIRED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_PARKED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_PARKED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_REJECTED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_REJECTED"
)
NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_CONTRACT = (
    "AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT"
)

# Market/timeframe scope reused from Block 111 so this approval can never drift from
# the spot/D1 scope the research design review interprets evidence against.
...
# The four assets the external bot evidence watches, reused from Block 111.
WATCHED_UNIVERSE: tuple[str, ...] = tuple(_DESIGN_WATCHED_UNIVERSE)
_WATCHED_UNIVERSE_SET: frozenset[str] = frozenset(WATCHED_UNIVERSE)

# Per-asset evidence stance, reused verbatim from Block 111 so the approval can never
# weaken it.
...
# Multi-asset sync gate, reused from Block 111.
MIN_MULTI_ASSET_SYNC_SCORE = _DESIGN_MIN_SYNC_SCORE
MIN_SYNCHRONIZED_ASSETS = _DESIGN_MIN_SYNC_ASSETS

# Mandatory trade-coordinator rules, reused from Block 111.
TRADE_COORDINATOR_RULES: tuple[str, ...] = tuple(
    _DESIGN_TRADE_COORDINATOR_RULES
)

# Bot-state policy, reused from Block 111. A declared bot state must be one of the
...
RESEARCH_DESIGN_APPROVAL_EVALUATION_OUTCOMES: tuple[str, ...] = (
    "PASS",
    "WATCH",
    "FAIL",
)
...
RESEARCH_DESIGN_APPROVAL_REQUIRED_SAFEGUARDS: tuple[str, ...] = (
...
RESEARCH_DESIGN_APPROVAL_VALIDATION_BOUNDARIES: tuple[str, ...] = (
...
RESEARCH_DESIGN_APPROVAL_SAFETY_POSTURE: dict[str, bool] = {
    "acquires_data": False,
    "fetches_data": False,
...
ALLOWED_RESEARCH_DESIGN_APPROVAL_MODES: tuple[str, ...] = (
    "research_only",
    "research-only",
    "research only",
    "approval_only",
...
# Descriptive text fields a human must record on a proposed research-design-approval packet.
# Absent -> NEEDS_MORE_INFO.
RESEARCH_DESIGN_APPROVAL_REQUIRED_TEXT_FIELDS: tuple[str, ...] = (
    "research_design_approval_packet_id",
    "upstream_research_design_review_id",
    "research_design_review_contract_version",
    "approval_scope",
    "approval_mode",
...
RESEARCH_DESIGN_APPROVAL_REQUIRED_AFFIRMATIONS: tuple[str, ...] = (
    ...
    "approved_research_design_review_was_ready",
...
# Full set of required research-design-approval packet fields.
REQUIRED_RESEARCH_DESIGN_APPROVAL_FIELDS: tuple[str, ...] = (
    RESEARCH_DESIGN_APPROVAL_REQUIRED_TEXT_FIELDS
    + RESEARCH_DESIGN_APPROVAL_REQUIRED_AFFIRMATIONS
)
...
RESEARCH_DESIGN_APPROVAL_FORBIDDEN_ALLOW_FLAGS: tuple[str, ...] = (
    ...
    "weaken_research_design_review",
    "relax_research_design_review_safety",
)
...
_RESEARCH_DESIGN_APPROVAL_BLOCKED_CAPABILITIES: tuple[str, ...] = (
...
_RESEARCH_DESIGN_APPROVAL_REFERENCE_PLACEHOLDER = (
    "Crypto-D1 research-design-approval packet is a paper placeholder describing a proposed "
    "human research design review for the approved external-bot-evidence research plan: "
...
_RESEARCH_DESIGN_APPROVAL_VERDICT_RATIONALE_PLACEHOLDER = (
    "Research-design verdict rationale is a paper placeholder for a human-recorded "
    "judgement of whether a proposed research design review of the approved "
...
_OPERATOR_NOTES: tuple[str, ...] = (
    "This is a crypto-d1 strategy candidate research design review contract template and "
    "is execution-free.",
    "It records, on paper, the proposed human approval of the external-bot-evidence "
    "research design review recorded by the Block 111 contract; it "
    "runs no research and touches no external bot.",
    "It records a paper research-design-approval packet only and writes no report file.",
...
_HUMAN_OPERATOR_REQUIRED_NEXT_STEPS: tuple[str, ...] = (
    "A human approver must record a research-design-approval verdict with a supporting "
    "rationale on paper.",
    "A human approver must confirm the research design review under approval keeps the declared "
...
_REQUIRED_CONTRACT_FIELDS: tuple[str, ...] = (
    "schema_version",
    "crypto_d1_strategy_candidate_research_design_review_contract_schema_version",
    ...
    "protocol_name",
    "crypto_d1_strategy_candidate_research_design_approval_contract_active",
    "crypto_d1_strategy_candidate_research_design_approval_contract_state",
    "crypto_d1_strategy_candidate_research_design_review_contract_recognized",
    "upstream_research_design_review_verdict",
    "upstream_research_design_review_next_gate",
    "upstream_research_design_review_mode",
    "research_design_approval_contract_required",
    "research_design_approval_next_required_action",
    "research_design_approval_current_stage",
    "required_market_type",
    "required_timeframe",
    ...
    "research_design_approval_required_safeguards",
    "research_design_approval_validation_boundaries",
    "research_design_approval_packet_reference_placeholder",
    "research_design_approval_verdict",
    "research_design_approval_verdict_reasons",
    "evaluated_research_design_approval_packet",
    "allowed_research_design_approval_verdicts",
    "required_research_design_approval_fields",
    "research_design_approval_required_text_fields",
    "research_design_approval_required_affirmations",
    ...
    "allowed_research_design_approval_modes",
    "automated_approval_markers",
    "research_design_approval_verdict_rationale_placeholder",
    "research_design_approval_blocked_capabilities",
    "remaining_real_world_capabilities_blocked",
...
def _safety_posture() -> dict[str, bool]:
    ...
    return dict(RESEARCH_DESIGN_APPROVAL_SAFETY_POSTURE)
...
def _reject_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    ...
    for flag in RESEARCH_DESIGN_APPROVAL_FORBIDDEN_ALLOW_FLAGS:
...
def _park_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    ...
    for flag in ("park", "parked", "defer", "deferred", "hold"):
        if _truthy(packet.get(flag)):
            reasons.append("approver_parked_research_design_approval")
            break
...
def _missing_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    """Return unmet requirements for an otherwise-safe research-design-approval packet:
    absent text fields, unaffirmed flags, or an incomplete BTC/ETH/SOL/XRP designed
    watched universe."""
    missing: list[str] = []

    for key in RESEARCH_DESIGN_APPROVAL_REQUIRED_TEXT_FIELDS:
...
def evaluate_crypto_d1_strategy_candidate_research_design_approval(
    packet: Any,
) -> dict[str, Any]:
    """Return a deterministic verdict for a proposed research-design-approval packet. Pure;
    ...
    if not p:
        return {
            "verdict": RESEARCH_DESIGN_APPROVAL_VERDICT_NEEDS_MORE_INFO,
            "reasons": ("research_design_approval_packet_missing",),
        }

    rejected = _reject_reasons(p)
    if rejected:
        return {
            "verdict": RESEARCH_DESIGN_APPROVAL_VERDICT_REJECTED,
            "reasons": rejected,
        }
    ...
    if park:
        return {
            "verdict": RESEARCH_DESIGN_APPROVAL_VERDICT_PARKED,
            "reasons": park,
        }
    ...
    if not missing:
        return {
            "verdict": RESEARCH_DESIGN_APPROVAL_VERDICT_READY,
            "reasons": (
                "research_only_research_design_approval_fully_specified_human_approved_"
...
def _validate(contract: dict[str, Any]) -> dict[str, Any]:
    ...
    schema_ok = (
        safe.get("schema_version") == RESEARCH_DESIGN_APPROVAL_SCHEMA_VERSION
    )
    read_only = safe.get("read_only") is True
    research_only = safe.get("mode") == "RESEARCH_ONLY"
    stage_ok = (
        safe.get("stage")
        == "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_CONTRACT_ONLY"
    )
    ...
    verdicts_ok = (
        tuple(safe.get("allowed_research_design_approval_verdicts") or ())
        == ALLOWED_RESEARCH_DESIGN_APPROVAL_VERDICTS
    )
    fields_ok = (
        tuple(safe.get("required_research_design_approval_fields") or ())
        == REQUIRED_RESEARCH_DESIGN_APPROVAL_FIELDS
    )
    text_fields_ok = (
        tuple(safe.get("research_design_approval_required_text_fields") or ())
        == RESEARCH_DESIGN_APPROVAL_REQUIRED_TEXT_FIELDS
    )
    affirmations_ok = (
        tuple(safe.get("research_design_approval_required_affirmations") or ())
        == RESEARCH_DESIGN_APPROVAL_REQUIRED_AFFIRMATIONS
    )
    forbidden_flags_ok = (
        tuple(safe.get("research_design_approval_forbidden_allow_flags") or ())
        == RESEARCH_DESIGN_APPROVAL_FORBIDDEN_ALLOW_FLAGS
    )
    modes_ok = (
        tuple(safe.get("allowed_research_design_approval_modes") or ())
        == ALLOWED_RESEARCH_DESIGN_APPROVAL_MODES
    )
    markers_ok = (
    ...
    outcomes_ok = (
        tuple(safe.get("research_design_approval_evaluation_outcomes") or ())
        == RESEARCH_DESIGN_APPROVAL_EVALUATION_OUTCOMES
    )
    safeguards_ok = (
        tuple(safe.get("research_design_approval_required_safeguards") or ())
        == RESEARCH_DESIGN_APPROVAL_REQUIRED_SAFEGUARDS
    )
    boundaries_ok = (
        tuple(safe.get("research_design_approval_validation_boundaries") or ())
        == RESEARCH_DESIGN_APPROVAL_VALIDATION_BOUNDARIES
    )
    ...
    verdict_value_ok = (
        safe.get("research_design_approval_verdict")
        in ALLOWED_RESEARCH_DESIGN_APPROVAL_VERDICTS
    )
    blocked_present_ok = (
        len(tuple(safe.get("research_design_approval_blocked_capabilities") or ()))
        >= 1
    )
    ...
    return {
        ...
        "allowed_research_design_approval_verdicts_ok": verdicts_ok,
        "required_research_design_approval_fields_ok": fields_ok,
        "research_design_approval_required_text_fields_ok": text_fields_ok,
        "research_design_approval_required_affirmations_ok": affirmations_ok,
        "research_design_approval_forbidden_allow_flags_ok": forbidden_flags_ok,
        "allowed_research_design_approval_modes_ok": modes_ok,
        ...
        "research_design_approval_evaluation_outcomes_ok": outcomes_ok,
        "research_design_approval_required_safeguards_ok": safeguards_ok,
        "research_design_approval_validation_boundaries_ok": boundaries_ok,
        ...
        "research_design_approval_verdict_value_ok": verdict_value_ok,
        "research_design_approval_blocked_capabilities_present": blocked_present_ok,
...
def validate_crypto_d1_strategy_candidate_research_design_approval_contract(
...
def build_crypto_d1_strategy_candidate_research_design_approval_contract(
    upstream_research_design_review_signal: Any,
    research_design_approval_packet: Any = None,
) -> dict[str, Any]:
    ...
    contract becomes active solely when the upstream Block 111
    research-design-review signal is clearly READY for this gate:
    crypto_d1_strategy_candidate_research_design_review_contract_active is True,
    research_design_review_verdict ==
    STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY, next_gate ==
    CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY_SEPARATE_HUMAN_NEXT_STEP_REQUIRED,
    ...
    AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT regardless of
    the packet. Even when active and READY, every authorization field stays False.
    Returned dicts are fresh."""
    signal = (
        upstream_research_design_review_signal
        if isinstance(upstream_research_design_review_signal, dict)
        else {}
    )

    sig_verdict = _field(signal, "research_design_review_verdict")
    ...
    verdict_ok = (
        sig_verdict == UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_VERDICT
    )
    next_gate_ok = (
        sig_next_gate == UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_NEXT_GATE
    )
    mode_ok = sig_mode == UPSTREAM_REQUIRED_RESEARCH_DESIGN_REVIEW_MODE
    ...
    if contract_active:
        evaluation = (
            evaluate_crypto_d1_strategy_candidate_research_design_approval(
                research_design_approval_packet
            )
        )
        verdict = evaluation["verdict"]
        reasons = tuple(evaluation["reasons"])
    else:
        verdict = RESEARCH_DESIGN_APPROVAL_VERDICT_AWAIT
        reasons = (
            "await_crypto_d1_strategy_candidate_research_design_review_contract",
        )
    ...
    state = (
        RESEARCH_DESIGN_APPROVAL_STATE_ACTIVE
        if contract_active
        else RESEARCH_DESIGN_APPROVAL_STATE_BLOCKED
    )

    if not contract_active:
        next_gate = NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_CONTRACT
    elif verdict == RESEARCH_DESIGN_APPROVAL_VERDICT_READY:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_READY
    elif verdict == RESEARCH_DESIGN_APPROVAL_VERDICT_NEEDS_MORE_INFO:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_FIX_REQUIRED
    elif verdict == RESEARCH_DESIGN_APPROVAL_VERDICT_PARKED:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_PARKED
    else:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_APPROVAL_REJECTED
    ...
    echoed_packet = (
        dict(research_design_approval_packet)
        if isinstance(research_design_approval_packet, dict)
        else {}
    )

    contract = {
        "schema_version": RESEARCH_DESIGN_APPROVAL_SCHEMA_VERSION,
        "crypto_d1_strategy_candidate_research_design_review_contract_schema_version": (  # noqa: E501
            _RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION
        ),
        ...
        "label": DEFAULT_RESEARCH_DESIGN_APPROVAL_LABEL,
        "status": RESEARCH_DESIGN_APPROVAL_STATUS,
        "stage": (
            "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_APPROVAL_CONTRACT_ONLY"
        ),
        "mode": "RESEARCH_ONLY",
        ...
        "crypto_d1_strategy_candidate_research_design_review_contract_recognized": (  # noqa: E501
            contract_active
        ),
        "upstream_research_design_review_verdict": sig_verdict,
        "upstream_research_design_review_next_gate": sig_next_gate,
        "upstream_research_design_review_mode": sig_mode,
        "research_design_approval_contract_required": (
            research_design_approval_contract_required
        ),
        "research_design_approval_next_required_action": (
        ...
        "research_design_approval_verdict": verdict,
        "research_design_approval_verdict_reasons": reasons,
        "evaluated_research_design_approval_packet": echoed_packet,
        "allowed_research_design_approval_verdicts": (
            ALLOWED_RESEARCH_DESIGN_APPROVAL_VERDICTS
        ),
        "required_research_design_approval_fields": (
        ...
        "research_design_approval_blocked_capabilities": (
            _RESEARCH_DESIGN_APPROVAL_BLOCKED_CAPABILITIES
        ),
        "remaining_real_world_capabilities_blocked": (
            REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED
        ),
...
def render_crypto_d1_strategy_candidate_research_design_approval_contract_markdown(
    contract: dict[str, Any],
) -> str:
    """Return deterministic, non-empty markdown for a crypto-d1 strategy candidate
    research design review contract template. Pure; writes no file. Informational only."""
    verdicts = contract.get("allowed_research_design_approval_verdicts") or ()
    fields = contract.get("required_research_design_approval_fields") or ()
    text_fields = (
        contract.get("research_design_approval_required_text_fields") or ()
    )
    affirmations = (
        contract.get("research_design_approval_required_affirmations") or ()
    )
    forbidden_flags = (
        contract.get("research_design_approval_forbidden_allow_flags") or ()
    )
    modes = contract.get("allowed_research_design_approval_modes") or ()
    ...
    reasons = contract.get("research_design_approval_verdict_reasons") or ()
    blocked = contract.get("research_design_approval_blocked_capabilities") or ()
    remaining_blocked = (
        contract.get("remaining_real_world_capabilities_blocked") or ()
    )
    coordinator = contract.get("trade_coordinator_rules") or ()
    outcomes = contract.get("research_design_approval_evaluation_outcomes") or ()
    safeguards = contract.get("research_design_approval_required_safeguards") or ()
    boundaries = contract.get("research_design_approval_validation_boundaries") or ()
    ...
    lines: list[str] = []
    lines.append(
        "# Strategy Factory Crypto-D1 Strategy Candidate Research Design Approval "
        "Contract"
    )
    lines.append("")
    lines.append(
        "Template only: this is a crypto-d1-strategy-candidate-research-design-approval-"
        ...
        "-- it records only a paper research-design-approval verdict, is not wired into "
    ...
    lines.append(
        ...
        f"`{contract.get('crypto_d1_strategy_candidate_research_design_review_contract_schema_version', '')}`"  # noqa: E501
    )
    lines.append(
    ...
    lines.append(
        "Crypto-D1 strategy candidate research design review contract active: "
        f"{contract.get('crypto_d1_strategy_candidate_research_design_approval_contract_active', '')}"  # noqa: E501
    )
    lines.append(
        "Contract state: "
        f"{contract.get('crypto_d1_strategy_candidate_research_design_approval_contract_state', '')}"  # noqa: E501
    )
    lines.append(
        "Upstream research design review verdict: "
        f"{contract.get('upstream_research_design_review_verdict', '')}"
    )
    lines.append(
        "Upstream research design review next gate: "
        f"{contract.get('upstream_research_design_review_next_gate', '')}"
    )
    lines.append(
        "Upstream research design review mode: "
        f"{contract.get('upstream_research_design_review_mode', '')}"
    )
    lines.append(
        "Research design contract required: "
        f"{contract.get('research_design_approval_contract_required', '')}"
    )
    lines.append(
        "Research design next required action: "
        f"{contract.get('research_design_approval_next_required_action', '')}"
    )
    lines.append(
        "Research design current stage: "
        f"{contract.get('research_design_approval_current_stage', '')}"
    )
    lines.append(
        f"Verdict: {contract.get('research_design_approval_verdict', '')}"
    )
    ...
    for x in coordinator:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Evaluation Outcomes")
    lines.append("")
    for x in outcomes:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Required Safeguards")
    lines.append("")
    for x in safeguards:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Validation Boundaries")
    lines.append("")
    for x in boundaries:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Packet Reference")
    lines.append("")
    lines.append(
        "Research design packet reference: "
        f"{contract.get('research_design_approval_packet_reference_placeholder', '')}"
    )
    lines.append("")
    lines.append("## Research Design Approval Verdict Reasons")
    lines.append("")
    for x in reasons:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Allowed Research Design Approval Verdicts")
    lines.append("")
    for x in verdicts:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Required Research Design Approval Fields")
    lines.append("")
    for x in fields:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Required Text Fields")
    lines.append("")
    for x in text_fields:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Required Affirmations")
    lines.append("")
    for x in affirmations:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Forbidden Allow Flags")
    lines.append("")
    for x in forbidden_flags:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Allowed Research Design Approval Modes")
    lines.append("")
    for x in modes:
        lines.append(f"- `{x}`")
    lines.append("")
    ...
    for x in markers:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Approval Verdict Rationale")
    lines.append("")
    lines.append(
        "Research design verdict rationale: "
        f"{contract.get('research_design_approval_verdict_rationale_placeholder', '')}"
    )
    lines.append("")
    lines.append("## Research Design Approval Blocked Capabilities")
    lines.append("")
    for cap in blocked:
        lines.append(f"- `{cap}`")
    lines.append("")
