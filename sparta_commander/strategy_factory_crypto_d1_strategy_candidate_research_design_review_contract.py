...
proposed *research-design review* into a contract which VALIDATES, on paper,
whether the research design recorded by the Block 109 Crypto-D1 Strategy Candidate
Research Design Contract is complete, safe, research-only, and ready before any
later research-only step. It consumes the stable constants of the Research Design
Contract (Block 109), the Research Plan Approval Contract (Block 107), the Research
Plan Review Contract (Block 105), the External Bot Evidence Research Plan Contract
...
and the Next Research Protocol (Block 95), and only when the upstream research-design
signal is clearly the expected READY one
(crypto_d1_strategy_candidate_research_design_contract_active is True,
research_design_verdict == STRATEGY_CANDIDATE_RESEARCH_DESIGN_READY,
next_gate ==
CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_READY_SEPARATE_HUMAN_NEXT_STEP_REQUIRED,
mode == RESEARCH_ONLY, read_only is True, executes is False) evaluates a proposed
research-design-review packet on paper and returns a deterministic verdict describing
whether the review is ready, needs more info, must be rejected, or is parked.

It evaluates the SHAPE of a proposed review only -- whether the design's
...
The review preserves every external-bot-evidence safety stance carried by the
research design: external bot evidence stays observation-only and never becomes
...
Reaching a STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY verdict unlocks NOTHING
real. It only records, on paper, that a proposed research-design review stays in
scope and confirms every stance -- and even that still requires a separate, later,
human step. Any upstream research-design signal that is missing, malformed, not
READY, in the wrong mode, executable, non-read-only, or pointed at a different next
gate yields the AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_CONTRACT
verdict.

Public API:
  - RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION
  - DEFAULT_RESEARCH_DESIGN_REVIEW_LABEL
  - RESEARCH_DESIGN_REVIEW_STATUS
  - RESEARCH_DESIGN_REVIEW_SAFETY_POSTURE
  - RESEARCH_DESIGN_REVIEW_STATE_ACTIVE
  - RESEARCH_DESIGN_REVIEW_STATE_BLOCKED
  - RESEARCH_DESIGN_REVIEW_VERDICT_READY
  - RESEARCH_DESIGN_REVIEW_VERDICT_NEEDS_MORE_INFO
  - RESEARCH_DESIGN_REVIEW_VERDICT_REJECTED
  - RESEARCH_DESIGN_REVIEW_VERDICT_PARKED
  - RESEARCH_DESIGN_REVIEW_VERDICT_AWAIT
  - ALLOWED_RESEARCH_DESIGN_REVIEW_VERDICTS
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_VERDICT
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_NEXT_GATE
  - UPSTREAM_REQUIRED_RESEARCH_DESIGN_MODE
  - RESEARCH_DESIGN_REVIEW_NEXT_REQUIRED_ACTION
  - RESEARCH_DESIGN_REVIEW_CURRENT_STAGE
  - DECISION_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_CONTRACT_REQUIRED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_READY
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_FIX_REQUIRED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_PARKED
  - NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_REJECTED
  - NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_CONTRACT
  ...
  - RESEARCH_DESIGN_REVIEW_EVALUATION_OUTCOMES
  - RESEARCH_DESIGN_REVIEW_REQUIRED_SAFEGUARDS
  - RESEARCH_DESIGN_REVIEW_VALIDATION_BOUNDARIES
  - REQUIRED_RESEARCH_DESIGN_REVIEW_FIELDS
  - RESEARCH_DESIGN_REVIEW_REQUIRED_TEXT_FIELDS
  - RESEARCH_DESIGN_REVIEW_REQUIRED_AFFIRMATIONS
  - RESEARCH_DESIGN_REVIEW_FORBIDDEN_ALLOW_FLAGS
  - ALLOWED_RESEARCH_DESIGN_REVIEW_MODES
  - AUTOMATED_REVIEW_MARKERS
  - REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED
  - evaluate_crypto_d1_strategy_candidate_research_design_review(packet)
  - build_crypto_d1_strategy_candidate_research_design_review_contract(signal, packet=None)
  - validate_crypto_d1_strategy_candidate_research_design_review_contract(contract)
  - render_crypto_d1_strategy_candidate_research_design_review_contract_markdown(contract)
"""
...
from sparta_commander.strategy_factory_crypto_d1_strategy_candidate_research_design_contract import (  # noqa: E501
    RESEARCH_DESIGN_SCHEMA_VERSION as _RESEARCH_DESIGN_SCHEMA_VERSION,  # noqa: E501
    RESEARCH_DESIGN_VERDICT_READY as _RESEARCH_DESIGN_VERDICT_READY,  # noqa: E501
    NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_READY as _NEXT_GATE_RESEARCH_DESIGN_READY,  # noqa: E501
...
__all__ = [
    ...
    "AUTOMATED_REVIEW_MARKERS",
    "REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED",
    "evaluate_crypto_d1_strategy_candidate_research_design_review",
    "build_crypto_d1_strategy_candidate_research_design_review_contract",
    "validate_crypto_d1_strategy_candidate_research_design_review_contract",
    "render_crypto_d1_strategy_candidate_research_design_review_contract_markdown",
]

RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION = (
    "strategy_factory_crypto_d1_strategy_candidate_research_design_review_contract.v1"
)
DEFAULT_RESEARCH_DESIGN_REVIEW_LABEL = (
    "Strategy Factory Crypto-D1 Strategy Candidate Research Design Review Contract"
)
RESEARCH_DESIGN_REVIEW_STATUS = (
    "READ_ONLY_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT"
)

RESEARCH_DESIGN_REVIEW_STATE_ACTIVE = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT_ACTIVE"
)
RESEARCH_DESIGN_REVIEW_STATE_BLOCKED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT_BLOCKED"
)

RESEARCH_DESIGN_REVIEW_VERDICT_READY = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY"
)
RESEARCH_DESIGN_REVIEW_VERDICT_NEEDS_MORE_INFO = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_NEEDS_MORE_INFO"
)
RESEARCH_DESIGN_REVIEW_VERDICT_REJECTED = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_REJECTED"
)
RESEARCH_DESIGN_REVIEW_VERDICT_PARKED = (
    "STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_PARKED"
)
RESEARCH_DESIGN_REVIEW_VERDICT_AWAIT = (
    "AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_CONTRACT"
)

ALLOWED_RESEARCH_DESIGN_REVIEW_VERDICTS: tuple[str, ...] = (
    RESEARCH_DESIGN_REVIEW_VERDICT_READY,
    RESEARCH_DESIGN_REVIEW_VERDICT_NEEDS_MORE_INFO,
    RESEARCH_DESIGN_REVIEW_VERDICT_REJECTED,
    RESEARCH_DESIGN_REVIEW_VERDICT_PARKED,
...
# The exact upstream research-design signal this contract activates from
# (Block 109). The contract only becomes active when the upstream design contract
# is clearly READY, in RESEARCH_ONLY mode, read-only, non-executing, and pointed
# at exactly this research-design-review contract being built next.
UPSTREAM_REQUIRED_RESEARCH_DESIGN_VERDICT = (
    _RESEARCH_DESIGN_VERDICT_READY
)
UPSTREAM_REQUIRED_RESEARCH_DESIGN_NEXT_GATE = (
    _NEXT_GATE_RESEARCH_DESIGN_READY
)
UPSTREAM_REQUIRED_RESEARCH_DESIGN_MODE = "RESEARCH_ONLY"
...
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_READY = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_READY_SEPARATE_HUMAN_"
    "NEXT_STEP_REQUIRED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_FIX_REQUIRED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_FIX_REQUIRED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_PARKED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_PARKED"
)
NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_REJECTED = (
    "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_REJECTED"
)
NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_CONTRACT = (
    "AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_CONTRACT"
)

# Market/timeframe scope reused from Block 109 so this review can never drift from
# the spot/D1 scope the research design interprets evidence against.
...
# The four assets the external bot evidence watches, reused from Block 109.
WATCHED_UNIVERSE: tuple[str, ...] = tuple(_DESIGN_WATCHED_UNIVERSE)
_WATCHED_UNIVERSE_SET: frozenset[str] = frozenset(WATCHED_UNIVERSE)

# Per-asset evidence stance, reused verbatim from Block 109 so the review can never
# weaken it.
...
# Multi-asset sync gate, reused from Block 109.
MIN_MULTI_ASSET_SYNC_SCORE = _DESIGN_MIN_SYNC_SCORE
MIN_SYNCHRONIZED_ASSETS = _DESIGN_MIN_SYNC_ASSETS

# Mandatory trade-coordinator rules, reused from Block 109.
TRADE_COORDINATOR_RULES: tuple[str, ...] = tuple(
    _DESIGN_TRADE_COORDINATOR_RULES
)

# Bot-state policy, reused from Block 109. A declared bot state must be one of the
...
RESEARCH_DESIGN_REVIEW_EVALUATION_OUTCOMES: tuple[str, ...] = (
    "PASS",
    "WATCH",
    "FAIL",
)
...
RESEARCH_DESIGN_REVIEW_REQUIRED_SAFEGUARDS: tuple[str, ...] = (
...
RESEARCH_DESIGN_REVIEW_VALIDATION_BOUNDARIES: tuple[str, ...] = (
...
RESEARCH_DESIGN_REVIEW_SAFETY_POSTURE: dict[str, bool] = {
    "acquires_data": False,
    "fetches_data": False,
...
AUTOMATED_REVIEW_MARKERS: tuple[str, ...] = (
    "auto",
    "automated",
    "automation",
    "bot",
...
# REJECTED (the review tries to operate outside research-only / review-only scope).
ALLOWED_RESEARCH_DESIGN_REVIEW_MODES: tuple[str, ...] = (
    "research_only",
    "research-only",
    "research only",
    "review_only",
    "review-only",
    "review only",
    "research_only_review_only",
)

# Descriptive text fields a human must record on a proposed research-design-review packet.
# Absent -> NEEDS_MORE_INFO.
RESEARCH_DESIGN_REVIEW_REQUIRED_TEXT_FIELDS: tuple[str, ...] = (
    "research_design_review_packet_id",
    "upstream_research_design_id",
    "research_design_contract_version",
    "review_scope",
    "review_mode",
    "reviewed_declared_bot_state",
    "reviewed_watched_universe",
    "reviewed_asset_stance_summary",
    "reviewed_multi_asset_sync_interpretation",
    "reviewed_lead_lag_interpretation",
    "reviewed_atr_threshold_study_boundary",
    "reviewed_trade_coordinator_rule_summary",
    "reviewed_closed_trade_proof_requirement",
    "review_candidate_evaluation_rule_summary",
    "review_pass_watch_fail_logic_summary",
    "review_observation_only_evidence_handling",
    "review_required_safeguard_summary",
    "review_future_validation_boundary",
    "reviewer_name_or_id",
...
# Affirmation flags the packet must carry (each affirmed True). The "reviewed_*"
# flags are positive confirmations that the human reviewer checked and upholds each
# external-bot-evidence stance carried by the approved research plan; the "no_*" /
# "review_*" flags confirm the design itself permits no real-world thing. A
...
RESEARCH_DESIGN_REVIEW_REQUIRED_AFFIRMATIONS: tuple[str, ...] = (
    # Generic design acknowledgements
    "explicit_human_design",
    "research_only_acknowledgement",
    "review_only_acknowledgement",
    "no_execution_acknowledgement",
    # Design-specific scope acknowledgements
    "reviewed_research_design_was_ready",
    "review_is_research_only_human_reviewed_for_next_step_only",
    "review_authorizes_no_execution_or_real_work",
    # Rule 1
    "reviewed_external_bot_state_is_watch_safe_observe_not_go",
    # Rule 2
    "reviewed_bot_evidence_is_external_evidence_only",
    "reviewed_bot_evidence_not_execution_permission",
    # Rule 3
    "reviewed_failsafe_or_insufficient_data_is_observe_log_only",
    # Rule 4
    "reviewed_closed_trade_proof_required_before_promotion",
    # Rule 5
    "reviewed_sol_main_candidate_blocked_from_execution",
    # Rule 6
    "reviewed_xrp_watchlist_only_insufficient_history",
    # Rule 7
    "reviewed_btc_dormant_blocked_from_expansion",
    # Rule 8
    "reviewed_eth_early_pressure_only",
    # Rule 9
    "reviewed_multi_asset_sync_threshold_required_before_confirmation",
    # Rule 10
    "reviewed_lead_lag_not_used_as_confirmation",
    "reviewed_lagged_sync_not_used_as_confirmation",
    # Rule 11
    "reviewed_adaptive_atr_thresholds_offline_study_only",
    "reviewed_no_live_threshold_changes",
    # Rule 12
    "reviewed_trade_coordinator_max_one_open_trade_per_symbol",
    "reviewed_trade_coordinator_no_same_direction_adds",
    "reviewed_trade_coordinator_treat_exchanges_as_same_symbol",
    "reviewed_trade_coordinator_block_opposite_direction",
    # Rule 13
    "reviewed_no_strategy_promotion",
    "reviewed_no_paper_expansion",
    "reviewed_no_live_activation",
    # Design-specific structure acknowledgements
    "reviewed_candidate_evaluation_is_observation_only",
    "reviewed_pass_watch_fail_is_paper_judgement_only",
    "reviewed_validation_boundary_blocks_real_execution",
...
# Full set of required research-design-review packet fields.
REQUIRED_RESEARCH_DESIGN_REVIEW_FIELDS: tuple[str, ...] = (
    RESEARCH_DESIGN_REVIEW_REQUIRED_TEXT_FIELDS
    + RESEARCH_DESIGN_REVIEW_REQUIRED_AFFIRMATIONS
)
...
RESEARCH_DESIGN_REVIEW_FORBIDDEN_ALLOW_FLAGS: tuple[str, ...] = (
    ...
    "review_for_execution",
    "review_grants_execution",
    "treat_review_as_execution_permission",
    "proceed_to_real_validation",
    "review_authorizes_real_validation",
    ...
    "weaken_research_design",
    "relax_research_design_safety",
)
...
_RESEARCH_DESIGN_REVIEW_BLOCKED_CAPABILITIES: tuple[str, ...] = (
...
_RESEARCH_DESIGN_REVIEW_REFERENCE_PLACEHOLDER = (
    "Crypto-D1 research-design-review packet is a paper placeholder describing a proposed "
...
_RESEARCH_DESIGN_REVIEW_VERDICT_RATIONALE_PLACEHOLDER = (
...
_OPERATOR_NOTES: tuple[str, ...] = (
    ...
    "is execution-free.",
    "It records, on paper, the proposed human review of the external-bot-evidence "
    "research design recorded by the Block 109 contract; it "
    "runs no research and touches no external bot.",
    "It records a paper research-design-review packet only and writes no report file.",
    ...
    "A human reviewer alone may record this verdict; no automated reviewer is "
    "accepted, and any READY still requires a separate, later, human step.",
)

_HUMAN_OPERATOR_REQUIRED_NEXT_STEPS: tuple[str, ...] = (
    "A human reviewer must record a research-design-review verdict with a supporting "
    "rationale on paper.",
    "A human reviewer must confirm the research design under review keeps the declared "
    ...
    "permission.",
    "A human reviewer must confirm the candidate-evaluation rules stay "
    "observation-only, the PASS/WATCH/FAIL logic stays a paper judgement, and "
    "every validation boundary blocks real execution.",
    "A human reviewer must confirm the per-asset stances are upheld: SOL blocked "
    "from execution, XRP watchlist-only, BTC dormant/blocked from expansion, ETH "
    "early-pressure only.",
    "A human reviewer must confirm market confirmation stays gated behind a 60+ "
    ...
    "promotion.",
    "A human reviewer must confirm no strategy promotion, no paper expansion, and "
...
_REQUIRED_CONTRACT_FIELDS: tuple[str, ...] = (
    "schema_version",
    "crypto_d1_strategy_candidate_research_design_contract_schema_version",
    ...
    "protocol_name",
    "crypto_d1_strategy_candidate_research_design_review_contract_active",
    "crypto_d1_strategy_candidate_research_design_review_contract_state",
    "crypto_d1_strategy_candidate_research_design_contract_recognized",
    "upstream_research_design_verdict",
    "upstream_research_design_next_gate",
    "upstream_research_design_mode",
    "research_design_review_contract_required",
    "research_design_review_next_required_action",
    "research_design_review_current_stage",
    "required_market_type",
    "required_timeframe",
    ...
    "research_design_review_required_safeguards",
    "research_design_review_validation_boundaries",
    "research_design_review_packet_reference_placeholder",
    "research_design_review_verdict",
    "research_design_review_verdict_reasons",
    "evaluated_research_design_review_packet",
    "allowed_research_design_review_verdicts",
    "required_research_design_review_fields",
    "research_design_review_required_text_fields",
    "research_design_review_required_affirmations",
    ...
    "allowed_research_design_review_modes",
    "automated_review_markers",
    "research_design_review_verdict_rationale_placeholder",
    "research_design_review_blocked_capabilities",
    "remaining_real_world_capabilities_blocked",
...
def _safety_posture() -> dict[str, bool]:
    ...
    return dict(RESEARCH_DESIGN_REVIEW_SAFETY_POSTURE)
...
def _reject_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    ...
    outcome, an automated reviewer, or granted authority."""
    reasons: list[str] = []

    for flag in RESEARCH_DESIGN_REVIEW_FORBIDDEN_ALLOW_FLAGS:
    ...
    bot_state = packet.get("reviewed_declared_bot_state")
    if _present(bot_state):
        state_value = _scalar(bot_state)
        if state_value in _FORBIDDEN_BOT_STATE_SET:
            reasons.append("reviewed_bot_state_go_not_permitted")
        elif state_value not in _ALLOWED_BOT_STATE_SET:
            reasons.append("disallowed_reviewed_bot_state")

    if _truthy(packet.get("reviewed_claims_market_confirmation")):
        score = _as_number(packet.get("reviewed_multi_asset_sync_score"))
        count = _as_number(packet.get("reviewed_synchronized_asset_count"))
        if (
            score is None
            ...
            reasons.append(
                "reviewed_market_confirmation_below_multi_asset_sync_threshold"
            )

    watched = _upper_token_set(packet.get("reviewed_watched_universe"))
    extras = watched - _WATCHED_UNIVERSE_SET
    if extras:
        reasons.append("non_core_assets_in_reviewed_watched_universe")

    outcome = packet.get("reviewed_candidate_evaluation_outcome")
    if _present(outcome):
    ...
    for key in (
        ...
        if _scalar(packet.get(key)) in AUTOMATED_REVIEW_MARKERS:
...
def _park_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    """Return parking reasons when a reviewer explicitly parks or defers the whole
    research-design-review lane."""
    reasons: list[str] = []
    park_values = {
    ...
    for flag in ("park", "parked", "defer", "deferred", "hold"):
        if _truthy(packet.get(flag)):
            reasons.append("reviewer_parked_research_design_review")
            break
...
def _missing_reasons(packet: dict[str, Any]) -> tuple[str, ...]:
    """Return unmet requirements for an otherwise-safe research-design-review packet:
    absent text fields, unaffirmed flags, or an incomplete BTC/ETH/SOL/XRP designed
    watched universe."""
    missing: list[str] = []

    for key in RESEARCH_DESIGN_REVIEW_REQUIRED_TEXT_FIELDS:
    ...
    for asset in WATCHED_UNIVERSE:
        if asset not in watched:
            missing.append(f"reviewed_watched_universe_missing_{asset}")

    return tuple(missing)


def evaluate_crypto_d1_strategy_candidate_research_design_review(
    packet: Any,
) -> dict[str, Any]:
    """Return a deterministic verdict for a proposed research-design-review packet. Pure;
    ...
    asset / bad evaluation outcome / automated reviewer / authority-granting) is
    ...
    if not p:
        return {
            "verdict": RESEARCH_DESIGN_REVIEW_VERDICT_NEEDS_MORE_INFO,
            "reasons": ("research_design_review_packet_missing",),
        }

    rejected = _reject_reasons(p)
    if rejected:
        return {
            "verdict": RESEARCH_DESIGN_REVIEW_VERDICT_REJECTED,
            "reasons": rejected,
        }
    ...
    if park:
        return {
            "verdict": RESEARCH_DESIGN_REVIEW_VERDICT_PARKED,
            "reasons": park,
        }
    ...
    if not missing:
        return {
            "verdict": RESEARCH_DESIGN_REVIEW_VERDICT_READY,
            "reasons": (
                "research_only_research_design_review_fully_specified_human_reviewed_"
...
def _validate(contract: dict[str, Any]) -> dict[str, Any]:
    ...
    schema_ok = (
        safe.get("schema_version") == RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION
    )
    read_only = safe.get("read_only") is True
    research_only = safe.get("mode") == "RESEARCH_ONLY"
    stage_ok = (
        safe.get("stage")
        == "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT_ONLY"
    )
    ...
    verdicts_ok = (
        tuple(safe.get("allowed_research_design_review_verdicts") or ())
        == ALLOWED_RESEARCH_DESIGN_REVIEW_VERDICTS
    )
    fields_ok = (
        tuple(safe.get("required_research_design_review_fields") or ())
        == REQUIRED_RESEARCH_DESIGN_REVIEW_FIELDS
    )
    text_fields_ok = (
        tuple(safe.get("research_design_review_required_text_fields") or ())
        == RESEARCH_DESIGN_REVIEW_REQUIRED_TEXT_FIELDS
    )
    affirmations_ok = (
        tuple(safe.get("research_design_review_required_affirmations") or ())
        == RESEARCH_DESIGN_REVIEW_REQUIRED_AFFIRMATIONS
    )
    forbidden_flags_ok = (
        tuple(safe.get("research_design_review_forbidden_allow_flags") or ())
        == RESEARCH_DESIGN_REVIEW_FORBIDDEN_ALLOW_FLAGS
    )
    modes_ok = (
        tuple(safe.get("allowed_research_design_review_modes") or ())
        == ALLOWED_RESEARCH_DESIGN_REVIEW_MODES
    )
    markers_ok = (
        tuple(safe.get("automated_review_markers") or ())
        == AUTOMATED_REVIEW_MARKERS
    )
    watched_ok = (
    ...
    outcomes_ok = (
        tuple(safe.get("research_design_review_evaluation_outcomes") or ())
        == RESEARCH_DESIGN_REVIEW_EVALUATION_OUTCOMES
    )
    safeguards_ok = (
        tuple(safe.get("research_design_review_required_safeguards") or ())
        == RESEARCH_DESIGN_REVIEW_REQUIRED_SAFEGUARDS
    )
    boundaries_ok = (
        tuple(safe.get("research_design_review_validation_boundaries") or ())
        == RESEARCH_DESIGN_REVIEW_VALIDATION_BOUNDARIES
    )
    ...
    verdict_value_ok = (
        safe.get("research_design_review_verdict")
        in ALLOWED_RESEARCH_DESIGN_REVIEW_VERDICTS
    )
    blocked_present_ok = (
        len(tuple(safe.get("research_design_review_blocked_capabilities") or ()))
        >= 1
    )
    ...
    return {
        ...
        "allowed_research_design_review_verdicts_ok": verdicts_ok,
        "required_research_design_review_fields_ok": fields_ok,
        "research_design_review_required_text_fields_ok": text_fields_ok,
        "research_design_review_required_affirmations_ok": affirmations_ok,
        "research_design_review_forbidden_allow_flags_ok": forbidden_flags_ok,
        "allowed_research_design_review_modes_ok": modes_ok,
        "automated_review_markers_ok": markers_ok,
        ...
        "research_design_review_evaluation_outcomes_ok": outcomes_ok,
        "research_design_review_required_safeguards_ok": safeguards_ok,
        "research_design_review_validation_boundaries_ok": boundaries_ok,
        ...
        "research_design_review_verdict_value_ok": verdict_value_ok,
        "research_design_review_blocked_capabilities_present": blocked_present_ok,
...
def validate_crypto_d1_strategy_candidate_research_design_review_contract(
...
def build_crypto_d1_strategy_candidate_research_design_review_contract(
    upstream_research_design_signal: Any,
    research_design_review_packet: Any = None,
) -> dict[str, Any]:
    ...
    contract becomes active solely when the upstream Block 109
    research-design signal is clearly READY for this gate:
    crypto_d1_strategy_candidate_research_design_contract_active is True,
    research_design_verdict ==
    STRATEGY_CANDIDATE_RESEARCH_DESIGN_READY, next_gate ==
    CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_READY_SEPARATE_HUMAN_NEXT_STEP_REQUIRED,
    ...
    AWAIT_CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_CONTRACT regardless of
    the packet. Even when active and READY, every authorization field stays False.
    Returned dicts are fresh."""
    signal = (
        upstream_research_design_signal
        if isinstance(upstream_research_design_signal, dict)
        else {}
    )

    sig_verdict = _field(signal, "research_design_verdict")
    ...
    verdict_ok = (
        sig_verdict == UPSTREAM_REQUIRED_RESEARCH_DESIGN_VERDICT
    )
    next_gate_ok = (
        sig_next_gate == UPSTREAM_REQUIRED_RESEARCH_DESIGN_NEXT_GATE
    )
    mode_ok = sig_mode == UPSTREAM_REQUIRED_RESEARCH_DESIGN_MODE
    ...
    if contract_active:
        evaluation = (
            evaluate_crypto_d1_strategy_candidate_research_design_review(
                research_design_review_packet
            )
        )
        verdict = evaluation["verdict"]
        reasons = tuple(evaluation["reasons"])
    else:
        verdict = RESEARCH_DESIGN_REVIEW_VERDICT_AWAIT
        reasons = (
            "await_crypto_d1_strategy_candidate_research_design_contract",
        )
    ...
    state = (
        RESEARCH_DESIGN_REVIEW_STATE_ACTIVE
        if contract_active
        else RESEARCH_DESIGN_REVIEW_STATE_BLOCKED
    )

    if not contract_active:
        next_gate = NEXT_GATE_AWAIT_CRYPTO_D1_RESEARCH_DESIGN_CONTRACT
    elif verdict == RESEARCH_DESIGN_REVIEW_VERDICT_READY:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_READY
    elif verdict == RESEARCH_DESIGN_REVIEW_VERDICT_NEEDS_MORE_INFO:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_FIX_REQUIRED
    elif verdict == RESEARCH_DESIGN_REVIEW_VERDICT_PARKED:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_PARKED
    else:
        next_gate = NEXT_GATE_CRYPTO_D1_RESEARCH_DESIGN_REVIEW_REJECTED
    ...
    echoed_packet = (
        dict(research_design_review_packet)
        if isinstance(research_design_review_packet, dict)
        else {}
    )

    contract = {
        "schema_version": RESEARCH_DESIGN_REVIEW_SCHEMA_VERSION,
        "crypto_d1_strategy_candidate_research_design_contract_schema_version": (  # noqa: E501
            _RESEARCH_DESIGN_SCHEMA_VERSION
        ),
        ...
        "label": DEFAULT_RESEARCH_DESIGN_REVIEW_LABEL,
        "status": RESEARCH_DESIGN_REVIEW_STATUS,
        "stage": (
            "CRYPTO_D1_STRATEGY_CANDIDATE_RESEARCH_DESIGN_REVIEW_CONTRACT_ONLY"
        ),
        "mode": "RESEARCH_ONLY",
        ...
        "crypto_d1_strategy_candidate_research_design_contract_recognized": (  # noqa: E501
            contract_active
        ),
        "upstream_research_design_verdict": sig_verdict,
        "upstream_research_design_next_gate": sig_next_gate,
        "upstream_research_design_mode": sig_mode,
        "research_design_review_contract_required": (
            research_design_review_contract_required
        ),
        "research_design_review_next_required_action": (
        ...
        "research_design_review_verdict": verdict,
        "research_design_review_verdict_reasons": reasons,
        "evaluated_research_design_review_packet": echoed_packet,
        "allowed_research_design_review_verdicts": (
            ALLOWED_RESEARCH_DESIGN_REVIEW_VERDICTS
        ),
        "required_research_design_review_fields": (
        ...
        "automated_review_markers": AUTOMATED_REVIEW_MARKERS,
        "research_design_review_verdict_rationale_placeholder": (
            _RESEARCH_DESIGN_REVIEW_VERDICT_RATIONALE_PLACEHOLDER
        ),
        "research_design_review_blocked_capabilities": (
            _RESEARCH_DESIGN_REVIEW_BLOCKED_CAPABILITIES
        ),
        "remaining_real_world_capabilities_blocked": (
            REMAINING_REAL_WORLD_CAPABILITIES_BLOCKED
        ),
...
def render_crypto_d1_strategy_candidate_research_design_review_contract_markdown(
    contract: dict[str, Any],
) -> str:
    ...
    verdicts = contract.get("allowed_research_design_review_verdicts") or ()
    fields = contract.get("required_research_design_review_fields") or ()
    text_fields = (
        contract.get("research_design_review_required_text_fields") or ()
    )
    affirmations = (
        contract.get("research_design_review_required_affirmations") or ()
    )
    forbidden_flags = (
        contract.get("research_design_review_forbidden_allow_flags") or ()
    )
    modes = contract.get("allowed_research_design_review_modes") or ()
    markers = contract.get("automated_review_markers") or ()
    watched = contract.get("watched_universe") or ()
    stances = contract.get("asset_evidence_stances") or {}
    reasons = contract.get("research_design_review_verdict_reasons") or ()
    blocked = contract.get("research_design_review_blocked_capabilities") or ()
    remaining_blocked = (
        contract.get("remaining_real_world_capabilities_blocked") or ()
    )
    coordinator = contract.get("trade_coordinator_rules") or ()
    outcomes = contract.get("research_design_review_evaluation_outcomes") or ()
    safeguards = contract.get("research_design_review_required_safeguards") or ()
    boundaries = contract.get("research_design_review_validation_boundaries") or ()
    ...
    lines: list[str] = []
    lines.append(
        "# Strategy Factory Crypto-D1 Strategy Candidate Research Design Review "
        "Contract"
    )
    lines.append("")
    lines.append(
        "Template only: this is a crypto-d1-strategy-candidate-research-design-review-"
        ...
        "-- it records only a paper research-design-review verdict, is not wired into "
    ...
    lines.append(
        ...
        f"`{contract.get('crypto_d1_strategy_candidate_research_design_contract_schema_version', '')}`"  # noqa: E501
    )
    lines.append(
    ...
    lines.append(
        ...
        f"{contract.get('crypto_d1_strategy_candidate_research_design_review_contract_active', '')}"  # noqa: E501
    )
    lines.append(
        "Contract state: "
        f"{contract.get('crypto_d1_strategy_candidate_research_design_review_contract_state', '')}"  # noqa: E501
    )
    lines.append(
        "Upstream research design verdict: "
        f"{contract.get('upstream_research_design_verdict', '')}"
    )
    lines.append(
        "Upstream research design next gate: "
        f"{contract.get('upstream_research_design_next_gate', '')}"
    )
    lines.append(
        "Upstream research design mode: "
        f"{contract.get('upstream_research_design_mode', '')}"
    )
    lines.append(
        "Research design contract required: "
        f"{contract.get('research_design_review_contract_required', '')}"
    )
    lines.append(
        "Research design next required action: "
        f"{contract.get('research_design_review_next_required_action', '')}"
    )
    lines.append(
        "Research design current stage: "
        f"{contract.get('research_design_review_current_stage', '')}"
    )
    lines.append(
        f"Verdict: {contract.get('research_design_review_verdict', '')}"
    )
    ...
    for x in coordinator:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Evaluation Outcomes")
    lines.append("")
    for x in outcomes:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Required Safeguards")
    lines.append("")
    for x in safeguards:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Validation Boundaries")
    lines.append("")
    for x in boundaries:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Packet Reference")
    lines.append("")
    lines.append(
        "Research design packet reference: "
        f"{contract.get('research_design_review_packet_reference_placeholder', '')}"
    )
    lines.append("")
    lines.append("## Research Design Review Verdict Reasons")
    lines.append("")
    for x in reasons:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Allowed Research Design Review Verdicts")
    lines.append("")
    for x in verdicts:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Required Research Design Review Fields")
    lines.append("")
    for x in fields:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Required Text Fields")
    lines.append("")
    for x in text_fields:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Required Affirmations")
    lines.append("")
    for x in affirmations:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Forbidden Allow Flags")
    lines.append("")
    for x in forbidden_flags:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Allowed Research Design Review Modes")
    lines.append("")
    for x in modes:
        lines.append(f"- `{x}`")
    lines.append("")
    ...
    for x in markers:
        lines.append(f"- `{x}`")
    lines.append("")
    lines.append("## Research Design Review Verdict Rationale")
    lines.append("")
    lines.append(
        "Research design verdict rationale: "
        f"{contract.get('research_design_review_verdict_rationale_placeholder', '')}"
    )
    lines.append("")
    lines.append("## Research Design Review Blocked Capabilities")
    lines.append("")
    for cap in blocked:
        lines.append(f"- `{cap}`")
    lines.append("")
