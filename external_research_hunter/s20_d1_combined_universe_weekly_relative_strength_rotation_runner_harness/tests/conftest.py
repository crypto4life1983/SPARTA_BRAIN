"""pytest fixtures + env guards for s20-d1 combined-universe weekly RS rotation runner harness tests."""
...
def synthetic_csv_path():
    return pathlib.Path(__file__).parent / "fixtures" / "synthetic_combined_universe_daily.csv"
...
def runner_harness_module():
    ...
    pkg = ("external_research_hunter."
           "s20_d1_combined_universe_weekly_relative_strength_rotation_runner_harness")
    import importlib
    return {
