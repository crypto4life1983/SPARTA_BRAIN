...
CONFIG = {
    ...
    "known_corporate_actions": [{'symbol': 'AAPL', 'date': '2020-08-31', 'type': 'split', 'factor': 4.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'NVDA', 'date': '2021-07-20', 'type': 'split', 'factor': 4.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'NVDA', 'date': '2024-06-10', 'type': 'split', 'factor': 10.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'AMZN', 'date': '2022-06-06', 'type': 'split', 'factor': 20.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'WMT', 'date': '2024-02-26', 'type': 'split', 'factor': 3.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'GOOGL', 'date': '2022-07-18', 'type': 'split', 'factor': 20.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'MRK', 'date': '2021-06-03', 'type': 'spinoff_factor', 'factor': 1.048, 'applied': True, 'dr9_verified': True, 'note': 'Organon spin-off; Tiingo encodes in splitFactor stream; applied under split_only -> return-continuous'}, {'symbol': 'NFLX', 'date': '2025-11-17', 'type': 'split', 'factor': 10.0, 'applied': True, 'dr9_verified': True}, {'symbol': 'HON', 'date': '2025-10-30', 'type': 'spinoff_factor', 'factor': 1.061, 'applied': True, 'dr9_verified': True, 'note': 'Solstice Advanced Materials spin-off; Tiingo encodes in splitFactor stream; applied under split_only -> return-continuous'}],
