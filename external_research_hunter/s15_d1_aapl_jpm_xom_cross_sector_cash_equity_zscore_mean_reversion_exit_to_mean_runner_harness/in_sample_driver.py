"""s15-d1-cross-sector in-sample driver. Filters reused DR9-passed cross-sector CSVs to IS window.
...
Reuses the s14-d1-cross-sector DR9-PASSED sealed CSVs (b13af03); split_only (DA15); no fresh fetch.
"""
...
def run_in_sample(*args, **kwargs):
    ...
    raise RuntimeError(
        ...
        "(Authorize s15-d1 cross-sector cash-equity z-score exit-to-mean P6 IS diagnostic only). "
