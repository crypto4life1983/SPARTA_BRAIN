"""pytest fixtures + env guards for s15-d1-cross-sector z-score exit-to-mean runner harness tests."""
...
def runner_harness_module():
    """Import the s15-d1-cross-sector z-score exit-to-mean runner harness package."""
