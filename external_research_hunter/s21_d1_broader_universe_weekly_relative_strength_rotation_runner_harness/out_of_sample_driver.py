"""s21-d1 out-of-sample driver. OOS window only; run_out_of_sample() STUB. OOS isolation. NO execution."""
...
def verify_csv_sha256(symbol):
    ...
    if actual != entry["sha256"]:
        raise Exception(f"S21_D1_OOS_CSV_SHA_MISMATCH: symbol={symbol} expected {entry['sha256']} got {actual}")
    return True
