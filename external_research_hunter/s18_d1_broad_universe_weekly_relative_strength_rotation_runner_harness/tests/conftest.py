"""pytest fixtures + env guards for s18-d1 weekly RS rotation runner harness tests."""
...
def synthetic_csv_path():
    return pathlib.Path(__file__).parent / "fixtures" / "synthetic_weekly_universe_daily.csv"
...
def runner_harness_module():
    ...
    pkg = ("external_research_hunter."
           "s18_d1_broad_universe_weekly_relative_strength_rotation_runner_harness")
    import importlib
    return {
