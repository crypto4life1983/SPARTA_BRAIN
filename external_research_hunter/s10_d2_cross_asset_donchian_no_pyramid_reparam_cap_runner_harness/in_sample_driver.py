"""s10 D2 in-sample driver -- local Databento DBN decoder + Donchian backtest.
...
OUTPUT_DIAGNOSTIC_JSON = Path(r"C:\SPARTA_BRAIN\reports\external_research_hunter\s10_d2_cross_asset_donchian_no_pyramid_reparam_cap_in_sample_diagnostic_result_sealed.json")
OUTPUT_DIAGNOSTIC_MD   = Path(r"C:\SPARTA_BRAIN\reports\external_research_hunter\s10_d2_cross_asset_donchian_no_pyramid_reparam_cap_in_sample_diagnostic_result_sealed.md")
...
def run_in_sample(*, expected_seals: Optional[Dict[str, str]] = None,
    ...
    return {
        "schema_id": "sparta.external_research_hunter.s10_d2_cross_asset_donchian_no_pyramid_reparam_cap_in_sample_diagnostic.v1",
...
if __name__ == "__main__":
    print("s10 D2 NO-PYRAMID in_sample_driver is BUILD-only scaffolding at P3.")
