"""s8 D1 in-sample driver -- local Databento DBN decoder + Donchian backtest.
...
Inherited sealed-chain anchors:
  predecessor (s8 selection plan):              6b7bdb4c350f4a779611546dcb32f6a83db2371c66d7b6ba0118121783801441
...
OUTPUT_DIAGNOSTIC_JSON = Path(r"C:\SPARTA_BRAIN\reports\external_research_hunter\s8_d1_cross_asset_donchian_no_pyramid_in_sample_diagnostic_result_sealed.json")
OUTPUT_DIAGNOSTIC_MD   = Path(r"C:\SPARTA_BRAIN\reports\external_research_hunter\s8_d1_cross_asset_donchian_no_pyramid_in_sample_diagnostic_result_sealed.md")
...
def _import_runner_main():
    ...
    """
    from external_research_hunter.s8_d1_cross_asset_donchian_no_pyramid_runner_harness import main as runner_main  # noqa: WPS433
    return runner_main
...
def run_in_sample(*, expected_seals: Optional[Dict[str, str]] = None,
    ...
    cap_tracker = runner_main.PortfolioCapTracker(
        ...
        per_market_cap=CONFIG["max_units_per_market"],  # S8-D1: 1
    )
    ...
    safety_warnings = {
        ...
        # S8-D1 NEW: per-market unit-count invariant violation (must always be 0 under max_units=1)
    ...
    # S8-D1: no-pyramid attestation block
    ...
    return {
        "schema_id": "sparta.external_research_hunter.s8_d1_cross_asset_donchian_no_pyramid_in_sample_diagnostic.v1",
        ...
        # S8-D1 specific: no-pyramid attestation block
...
if __name__ == "__main__":
    print("s8 D1 NO-PYRAMID in_sample_driver is BUILD-only scaffolding at P3.")
    ...
    print("S8-D1 invariant: max_units_per_market = 1 (no pyramid).")
    print("To execute (after explicit P6 operator authorization), call:")
    print("  from external_research_hunter.s8_d1_cross_asset_donchian_no_pyramid_runner_harness "
