...
- **run_id:** `458a1e7764fff90d`
- **generated_at:** 2026-06-03T20:19:27Z
...
- **input_data_hash (short):** `458a1e7764fff90d`

## Config mode: `momentum_robustness_v1`
- **batch:** Momentum lookback robustness sweep (momentum_robustness_v1)
...
- **momentum lookbacks swept:** [20, 30, 45, 60, 90]
...
- **per-family OOS trade counts (operator-side floor 30, NOT enforced in classify_run):**
  ...
  - `momentum_45`: total=51 meets_floor=True {'BTC': 22, 'ETH': 10, 'SOL': 19}
  - `momentum_60`: total=50 meets_floor=True {'BTC': 15, 'ETH': 11, 'SOL': 24}
  - `momentum_90`: total=33 meets_floor=True {'BTC': 9, 'ETH': 8, 'SOL': 16}
...
- **next_action:** 6 strategy result(s) show positive OOS + above-benchmark risk-adjusted return; this is INCOMPLETE evidence and does NOT promote the lane. PASS requires explicit operator review.
...
- `momentum_45_btc` (BTC): total_return=12.173544603848876, oos_total_return=1.192381266544651, oos_trade_count=22
- `momentum_60_btc` (BTC): total_return=8.144097689958965, oos_total_return=0.8540896626011687, oos_trade_count=15
...
- `momentum_45_eth` (ETH): total_return=25.003260885614605, oos_total_return=2.450340194315856, oos_trade_count=10
- `momentum_60_eth` (ETH): total_return=12.65674752628602, oos_total_return=2.4729337908066005, oos_trade_count=11
...
- `momentum_45_sol` (SOL): total_return=153.55258287303909, oos_total_return=0.9430172611502232, oos_trade_count=19
- `momentum_60_sol` (SOL): total_return=172.88706380935554, oos_total_return=1.3200317175740115, oos_trade_count=24
